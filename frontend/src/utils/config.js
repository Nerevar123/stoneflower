...
export const pricing = {
    ...
    textMajor: "В связи с минимальным размером листа выбранного вами материала (как правило, это 3000 х 1000 мм, 3000 х 1500 мм), и особенностью его раскроя  конечная цена не поддается расчету, применяемому в отношении традиционных облицовочных материалов.",
    textMinor: "У нас часто проводятся акции на одиночные изделия из материалов, которыми мы располагаем в остатках.",
