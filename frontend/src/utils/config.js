...
// export const disadvantagesTextContent = {
//   title: "Недостатки популярных аналогов в сегменте столешниц и фасадов",
//   disadvantages1: "Натуральный камень не обладает достаточной химической стойкостью: мрамор легко испортить вином или напитками, гранит облит оптическим эпоксидным составом, который царапается и мутнеет от кислотосодержащих моющих средств",
//   disadvantages2: "Большой удельный вес слэбов и плитки из натурального камня на фасадах зданий существенно увеличивают нагрузку на фундамент и при клеевом способе  крепления на фасаде не всегда выдерживают несколько погодных циклов",
//   disadvantages3: "Кварцевый агломерат не защищён от ультрафиолета, поэтому светлые его виды могут пожелтеть на солнце",
// };

// export const phasesTextContent = {
//   title: "Этапы работы",
...
export const portfolioContentRaw = [
  ...
  {
    _id: "602ef490d33788f4aa6f5aa4",
    title: "Стол обеденный 4",
    category: "Мебель",
    text: `Стол обеденный 140х90х75 см (под заказ размер до 310х110 см):
    – Поверхность Oxide Moro 3,5 mm (Laminam,Италия),
    – Дизайн "Каменный цветок"
