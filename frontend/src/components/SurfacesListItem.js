    ...
    return (
      <>
          ...
          <img
            ...
            src={arrow_right}
            alt="Иконка"
            style={{ ...style, width: "60px", height: "60px", right: "-5px" }}
            onClick={onClick}
          />
    ...
    return (
      <>
          ...
          <img
            ...
            src={arrow_left}
            alt="Иконка"
            style={{ ...style, width: "60px", height: "60px", left: "-5px", zIndex: '1'}}
            onClick={onClick}
          />
      </>
    );
  ...
  return (
    ...
    >
      <div className="surfaces__image-container">
        <img src={props.image} alt="Картинка" className="surfaces__image surfaces__image_main" />
        <div
      ...
      >
        {mouseIn? 'посмотреть каталог' : props.heading }
      </p>
    </div>
    {props.isMobile && props.content && (
    <div className={`surfaces__slider-container ${isSliderOpen? 'surfaces__slider-container_opened' :''}`}>
      <Slider {...settings}>
        {props.content.map((item) =>
          <div
          key={item._id}
          className="surfaces__slide"
        >
          <img
            key={item._id}
          ...
          />
                <p
        className="surfaces__material-description surfaces__material-description_visible"
